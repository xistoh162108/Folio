...
import { ReactiveTextScramble } from "@/components/reactive-text-scramble"
import { WaveformOverlay } from "@/components/waveform-overlay"
          ...
          {publicPage === "home" ? (
            ...
            <div className="flex-1 flex">
              ...
              <div className="w-1/2 relative overflow-hidden">
                <DigitalRain intensity={contactIntensity} emailStr={contactForm.email} isDarkMode={isDarkMode} />
                <WaveformOverlay message={contactForm.message} isDarkMode={isDarkMode} />
                <div className="absolute inset-0 flex flex-col items-center justify-center p-8">
                  <ReactiveTextScramble 
